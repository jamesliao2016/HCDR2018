...
def main(nrows=None):
    # Convert train
    # train = pd.read_csv('/Users/liaopeng3/.kaggle/train_v2.csv', dtype='object', nrows=nrows, encoding='utf-8')
    train = pd.read_csv('/Users/liaopeng3/logs/google_analytics_all/train.csv', dtype='object', nrows=nrows, encoding='utf-8')
    train = develop_json_fields(df=train)
    logger.info('Train done')

    # Convert test
    # test = pd.read_csv('/Users/liaopeng3/.kaggle/test_v2.csv', dtype='object', nrows=nrows, encoding='utf-8')
    test = pd.read_csv('/Users/liaopeng3/logs/google_analytics_all/test.csv', dtype='object', nrows=nrows, encoding='utf-8')
